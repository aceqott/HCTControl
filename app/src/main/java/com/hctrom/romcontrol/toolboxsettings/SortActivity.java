...
import com.hctrom.romcontrol.toolboxsettings.dragscroll.DragSortController;
import com.hctrom.romcontrol.toolboxsettings.dragscroll.DragSortListView;
...
public class SortActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.toolbox_activity_sort);
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle("Toolbox Sort");
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.toolbox_menu_sort, menu);
        return true;
    }
    ...
    private class SortableItemsAdapter extends BaseAdapter implements DragSortListView.DropListener {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                ...
                convertView = inf.inflate(R.layout.toolbox_sort_apps_item, null);
