...
import com.hctrom.romcontrol.prefs.ColorPickerDialog;
...
public class SelectorFragment extends Fragment implements ColorPickerDialog.OnColorChangedListener, View.OnClickListener {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.hexconverter_main_menu, menu);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 46 && data != null && data.getData() != null) {
            mSharedPreferences.edit().putString(HexConverterMain.URI_KEY, data.getData().toString()).apply();
            setUpImageView();
        } else {
    ...
    private void setUpImageView() {
        String uriString = mSharedPreferences.getString(HexConverterMain.URI_KEY, null);
        if (uriString != null) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mRequestCode = mSharedPreferences.getInt(HexConverterMain.FRAGMENT_CODE_KEY, 0);
        mColor = mSharedPreferences.getInt(COLOR_KEY, Color.RED);
        mIsCrop = mSharedPreferences.getBoolean(IS_CROP_KEY, false);
        switch (mRequestCode) {
            case 0:
                return inflater.inflate(R.layout.hexconverter_color_selector_layout, container, false);
            case 1:
                return inflater.inflate(R.layout.hexconverter_image_selector_layout, container, false);
            default:
