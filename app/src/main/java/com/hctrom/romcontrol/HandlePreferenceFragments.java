...
import com.hctrom.romcontrol.prefs.ColorPickerPreference;
import com.hctrom.romcontrol.prefs.FilePreference;
import com.hctrom.romcontrol.prefs.IntentDialogPreference;
import com.hctrom.romcontrol.prefs.MyEditTextPreference;
import com.hctrom.romcontrol.prefs.MyListPreference;
import com.hctrom.romcontrol.prefs.SeekBarPreference;
import com.hctrom.romcontrol.prefs.ThumbnailListPreference;
...
public class HandlePreferenceFragments implements SharedPreferences.OnSharedPreferenceChangeListener, Preference.OnPreferenceClickListener {
    ...
    * we can set specific values and even find specific preferences, as we loop through the map*/
    ...
    /*Method is called from OnPause of the preference fragment and it's build_prop_main function is
    ...
    * as well as retrieve a value from sharedpreferences or database*/
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        switch (p.getClass().getSimpleName()) {
            ...
            case "ColorPickerPreference":
                ...
                if (key.equals("main_digit_color")) {
                ...
                if (key.equals("main_letter_color")) {
                    Command c = new Command(0, "pkill com.android.contacts");
                    try {
                        RootTools.getShell(true).add(c);
                    } catch (IOException e) {
    ...
    public boolean onPreferenceClick(Preference preference) {
        if (preference.getKey() != null && preference.getKey().contains("script#")) {
            ...
            * Scripts are being copied from assets to the file dir of our app in onCreate of build_prop_main activity
            * If the script is found on it's intended path, it's checked for being executable.
            * Although we chmod 755 all the files upon copying them in build_prop_main activity,
        ...
        * As per instructions, devs are required to enter full path to the build_prop_main activity they wish to open in the intended app.
