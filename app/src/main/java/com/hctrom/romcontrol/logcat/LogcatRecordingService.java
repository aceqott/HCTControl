...
public class LogcatRecordingService extends IntentService {
	...
	private static final String ACTION_STOP_RECORDING = "com.hctrom.romcontrol.catlog.action.STOP_RECORDING";
	...
	private void handleCommand(Intent intent) {
        ...
        Notification notification = new Notification(R.drawable.catlog_status_icon, tickerText,
