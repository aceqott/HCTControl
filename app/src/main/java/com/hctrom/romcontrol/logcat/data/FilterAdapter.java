package com.hctrom.romcontrol.logcat.data;
...
public class FilterAdapter extends ArrayAdapter<FilterItem> {
	...
	public FilterAdapter(Context context, List<FilterItem> items) {
		super(context, R.layout.catlog_filter_with_delete, items);
	}
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		int resId = position == 0 ? R.layout.catlog_filter_with_add : R.layout.catlog_filter_with_delete;
