...
public class TelefonoLlamadasFragment extends PreferenceFragment implements Preference.OnPreferenceClickListener, UriSelectionPreference.OnUriSelectionRequestedListener {
    HandlePreferenceFragments hpf;
    private static final String LOG_TAG = TelefonoLlamadasFragment.class.getSimpleName();
    ...
    public TelefonoLlamadasFragment() {
        //empty public constructor
    }

    static TelefonoLlamadasFragment newInstance(String prefName) {
        TelefonoLlamadasFragment prefsFragment = new TelefonoLlamadasFragment();
