...
public class PhonePrefsFragment extends PreferenceFragment implements Preference.OnPreferenceClickListener, UriSelectionPreference.OnUriSelectionRequestedListener {
    HandlePreferenceFragments hpf;
    private static final String LOG_TAG = PhonePrefsFragment.class.getSimpleName();
    ...
    public PhonePrefsFragment() {
        //empty public constructor
    }

    static PhonePrefsFragment newInstance(String prefName) {
        PhonePrefsFragment prefsFragment = new PhonePrefsFragment();
