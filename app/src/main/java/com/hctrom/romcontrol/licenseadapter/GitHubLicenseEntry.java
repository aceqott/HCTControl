...
import com.hctrom.romcontrol.licenseadapter.internal.BaseLicenseEntry;
...
public class GitHubLicenseEntry extends BaseLicenseEntry {
  ...
  public static final Parcelable.Creator<GitHubLicenseEntry> CREATOR = new Parcelable.Creator<GitHubLicenseEntry>() {
    @Override
