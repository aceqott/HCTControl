...
public class GeneralFragment extends PreferenceFragment implements Preference.OnPreferenceClickListener, UriSelectionPreference.OnUriSelectionRequestedListener {
    ...
    static GeneralFragment newInstance(String prefName) {
        GeneralFragment prefsFragment = new GeneralFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        hpf = new HandlePreferenceFragments(getActivity(), this, "general_prefs");
